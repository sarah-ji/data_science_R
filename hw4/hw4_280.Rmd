...
top10busiestpathLL = top10busiestpathLL[,-c(6:7)]
names(top10busiestpathLL) = c("Destination", "Origin", "N_path", "Lat.D", "Long.D", "Lat.O", "Long.O")


final_top10pathLL = top10busiestpathLL %>%
mutate(Latitude_Destination = as.numeric(Lat.D), Longitude_Destination = as.numeric(Long.D), Latitude_Origin = as.numeric(Lat.O), Longitude_Origin = as.numeric(Long.O))

final10pathLatLong = final_top10pathLL[, -c(4:7)]
